...
This repository presents a remote sensing-based framework for monitoring and analyzing Lake Urmia environmental dynamics during 2016–2025 by integrating satellite imagery, climate datasets, statistical analysis, and machine learning approaches.
...
- Surface water extraction using Sentinel-2 MSI imagery
...
- Detect temporal trends using statistical methods
...
- Assessment of surface water reduction patterns
...
The lake is located in northwestern Iran and has experienced substantial surface water reduction during recent decades due to climate variability, drought conditions, and anthropogenic pressures.
...
The methodology integrates satellite remote sensing, climate analysis, statistical evaluation, and machine learning modeling.

The research framework consists of two main computational environments:

- Google Earth Engine for satellite image processing
- Python for statistical analysis and machine learning modeling
...
Python was used for environmental data analysis and predictive modeling:
...
| `Results` | Model performance metrics, prediction outputs, and statistical results |
